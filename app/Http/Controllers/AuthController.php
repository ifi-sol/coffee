        ...
        if($request->isMethod('post')){
           // echo "<pre>";print_r($request->all());exit;
            ...
            if($users->status == 'terminated'){
                return response()->json(array('status'  => false,   'message'   => 'Your account is blocked by Admin. For More Information Please Contact with CupCard Administrator. Thankyou'));
            }
